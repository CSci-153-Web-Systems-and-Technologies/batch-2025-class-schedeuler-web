// app/(authenticated)/instructor/components/InstructorMobileSidebar.tsx
"use client";
...
const mobileMenuItems = [
  ...
  { name: "My Classes", href: "/instructor/classes" },
  { name: "My Schedule", href: "/instructor/schedule" },
  { name: "Calendar", href: "/instructor/calendar" },
  { name: "Tasks", href: "/instructor/tasks" },
  { name: "Report", href: "/instructor/report" },
];

export default function InstructorMobileSidebar({ 
  isOpen, 
  onClose, 
  userName = "Instructor",
  userImage,
          ...
          <div className="p-4 border-b border-[var(--color-border)]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-muted-foreground)]">Instructor</p>
              </div>
            </div>
          </div>
