...
const SignupPage = () => {
  const [errorMessage, dispatch] = useActionState(signup, null)
  ...
  const handleSubmit = (formData: FormData) => {
    ...
    if (isGoogleEmail(userEmail)) {
      setFormError('Please use "Register with Google" for Gmail addresses to avoid login issues. Using email/password with Gmail may cause conflicts later.')
      return
    }
      ...
      <section className="hidden md:flex md:flex-1">
        <Card className="w-full h-full rounded-l-2xl shadow-none border-none overflow-hidden relative">
          <div
            ...
            style={{
              background:
                "linear-gradient(-139deg, #345AD3 0%, #4169E1 35%, #5B91F5 65%, #9FC3FF 100%)",
            }}
          />

          <div
            className="absolute -bottom-9 left-0 right-0 bg-cover bg-bottom bg-no-repeat md:h-[40%] lg:h-[60%]"
            style={{
              backgroundImage: "url('/auth-bg1.png')",
            }}
          />
            ...
            <div className="max-w-xs mt-4 flex flex-col items-center gap-3">
              <div className="flex items-center gap-3">
                ...
                <h1
                  ...
                  style={{
                    background:
                      "linear-gradient(96deg, #FFFFFF 0%, #B3CCFF 60%)",
              ...
              <p className="text-lg" style={{ color: "#EAF1FF" }}>
                ...
                <div className="grid gap-2">
                  ...
                  {isGoogleEmail(email) && (
                    <div className="text-amber-600 text-xs mt-1">
                      💡 Gmail detected - we recommend using Google Sign Up below
                    </div>
                  )}
                </div>
